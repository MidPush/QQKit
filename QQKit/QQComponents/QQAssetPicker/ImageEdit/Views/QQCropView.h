...
@class QQCropView;
@protocol QQCropViewDelegate <NSObject>

@optional
- (void)cropViewDidBecomeResettable:(nonnull QQCropView *)cropView;
- (void)cropViewDidBecomeNonResettable:(nonnull QQCropView *)cropView;
 ...
 */
@property (nonatomic, assign, readonly) QQImageCropStyle croppingStyle;

/**
 A grid view overlaid on top of the foreground image view's container.
 */
@property (nonnull, nonatomic, strong, readonly) QQCropOverlayView *gridOverlayView;
 ...
 */
@property (nullable, nonatomic, weak) id<QQCropViewDelegate> delegate;
